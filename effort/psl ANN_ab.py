...
params = {
    ...
    'Dense_2': [16,32,64],
    'epochs': [10],
    'initializer_1' : ['he_normal','glorot_normal'],
    'initializer_2' : ['he_normal','glorot_normal'],
    'initializer_3' : ['he_normal','glorot_normal'],
...
grid_search = grid_search.fit(Xa_lda_tn, yyy_tn)
